...
# Here I will walk through an invididual assignment, constrain above the threshold , binned into hucs, and constrained to only the HUC with the higest number of top5%

# I will also show maps of the priors here 
