...
KuskoNodes <- read.csv(here("/Users/benjaminmakhlouf/Research_repos/Shifting-Habitat-Mosaics-II/Data/Isotope Groups/kusko_noderelationships.csv"), header = TRUE, stringsAsFactors = FALSE)

# Load Kuskokwim Shapefile
## Must be this version of the shapefile!
kuskokwim_shapefile <- st_read(here("/Users/benjaminmakhlouf/Spatial Data/Shapefiles/AYK Shapefiles/kusko_edges_20210717.shp"))
