...
# Read production data 
prod2015 <- read.csv(here("Outputs","ProductionData","Yukon","2015_Yukon_Assignment_Results.csv"))
prod2016 <- read.csv(here("Outputs","ProductionData","Kusko","2018_Kusko_Assignment_Results.csv"))
prod2018 <- read.csv(here("Outputs","ProductionData","Kusko","2019_Kusko_Assignment_Results.csv"))
prod2021 <- read.csv(here("Outputs","ProductionData","Kusko","2020_Kusko_Assignment_Results.csv"))
