# cpue_analysis.R
# Functions for CPUE (Catch Per Unit Effort) quartile analysis
...
#' Perform CPUE Quartile Analysis
#'
...
# Modified CPUE_Quartile_Analysis function to use PNG output
...
CPUE_Quartile_Analysis <- function(year, watershed, sensitivity_threshold, min_error, 
  ...
  for (q in 1:length(quartile_subsets)) {
    ...
    trib_filepath <- file.path(here("Basin Maps/Quartile_Maps/Tribs"), 
